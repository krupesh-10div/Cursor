...
try {
	...
	$data = [
		...
		'to_company' => isset($_POST['to_company']) ? sanitize_text((string)$_POST['to_company']) : '',
		'validity_date' => isset($_POST['validity_date']) ? sanitize_text((string)$_POST['validity_date']) : '',
		'prepared_by' => isset($_POST['prepared_by']) ? sanitize_text((string)$_POST['prepared_by']) : '',
		...
		'include_tax' => isset($_POST['include_gst']) ? '1' : '',
		'tax_percent' => isset($_POST['tax_percent']) ? sanitize_text((string)$_POST['tax_percent']) : '8.6',

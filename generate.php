...
try {
	...
	$data = [
		...
		'company_phone' => isset($_POST['company_phone']) ? sanitize_text((string)$_POST['company_phone']) : '',
		'company_gstin' => isset($_POST['company_gstin']) ? sanitize_text((string)$_POST['company_gstin']) : '',
		'company_address' => isset($_POST['company_address']) ? sanitize_text((string)$_POST['company_address']) : '',
		'company_city' => isset($_POST['company_city']) ? sanitize_text((string)$_POST['company_city']) : '',
		'company_zip' => isset($_POST['company_zip']) ? sanitize_text((string)$_POST['company_zip']) : '',
		'company_state' => isset($_POST['company_state']) ? sanitize_text((string)$_POST['company_state']) : '',
		...
		'customer_phone' => isset($_POST['customer_phone']) ? sanitize_text((string)$_POST['customer_phone']) : '',
		'customer_gstin' => isset($_POST['customer_gstin']) ? sanitize_text((string)$_POST['customer_gstin']) : '',
		'customer_address' => isset($_POST['customer_address']) ? sanitize_text((string)$_POST['customer_address']) : '',
		'customer_city' => isset($_POST['customer_city']) ? sanitize_text((string)$_POST['customer_city']) : '',
		'customer_zip' => isset($_POST['customer_zip']) ? sanitize_text((string)$_POST['customer_zip']) : '',
		'customer_state' => isset($_POST['customer_state']) ? sanitize_text((string)$_POST['customer_state']) : '',
		'gst_included' => isset($_POST['gst_included']) ? (sanitize_text((string)$_POST['gst_included']) === '1') : false,
		'gst_percent' => isset($_POST['gst_percent']) ? (float)sanitize_text((string)$_POST['gst_percent']) : 0.0,
		'rounding' => isset($_POST['rounding']) ? sanitize_text((string)$_POST['rounding']) : '',
		'total_in_words' => isset($_POST['total_in_words']) ? (sanitize_text((string)$_POST['total_in_words']) === '1') : false,
		...
		'footer' => isset($_POST['footer']) ? sanitize_text((string)$_POST['footer']) : '',
		'signature_name' => isset($_POST['signature_name']) ? sanitize_text((string)$_POST['signature_name']) : '',
	];
